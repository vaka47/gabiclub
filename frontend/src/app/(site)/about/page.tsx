    ...
    <div className="space-y-12 pb-12">
      ...
      <section className="space-y-4">
        ...
        <p className="text-base text-slate-600">
          Мы считаем, что лыжные гонки - самый лучший вид спорта, и хотим, чтобы каждый открывал в нем что то новое для себя. В клубе Gabi помогают реализовывать цели всех учеников вне зависимости от уровня подготовки: сделать первые шаги на лыжах, улучшить технику, пробежать первые соревнования или подготовиться к серии стартов. Мы помогаем нашим ученикам быстрее прийти к желаемому результату.
        </p>
      </section>
